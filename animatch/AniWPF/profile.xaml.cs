...
namespace AniWPF
{
    public partial class Profile : Window
    {
        ...
        public Profile(IUserService userService, IAddedAnimeService addedAnimeService, IAnimeService animeService)
        {
            System.Random random = new System.Random();
            this.id = (int)random.NextInt64(1, 50);
